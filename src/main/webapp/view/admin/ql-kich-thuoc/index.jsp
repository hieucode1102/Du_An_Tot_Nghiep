            ...
            <table class="table table-striped">
                ...
                <c:forEach items="${pageData.content}" var="st">
                    <tr>
                        ...
                        <td><a href="/kich-thuoc/edit/${st.ID}" class="btn btn-warning">Chỉnh sửa</a></td>
                        <td>
                            <a href="/kich-thuoc/delete/${st.ID}" class="btn btn-danger"
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <c:if test="${pageData.number > 0}">
                        <li class="page-item">
                            <a class="page-link" href="/kich-thuoc/index?page=${pageData.number - 1}">Previous</a>
                        </li>
                    </c:if>
                    ...
                    <c:if test="${pageData.number +1 < pageData.getTotalPages()}">
                        <li class="page-item">
                            <a class="page-link" href="/kich-thuoc/index?page=${pageData.number + 1}">Next</a>
                        </li>
                    </c:if>
