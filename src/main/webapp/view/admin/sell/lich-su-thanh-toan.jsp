...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            <h2 style="text-align: center"> LỊCH SỬ THANH TOÁN</h2>
            ...
            <table class="table table-striped">
                ...
                <c:forEach items="${pageData.content}" var="st">
                    <tr>
                        ...
                        <td><a href="/sell/lich-su-thanh-toan/${st.ID}" class="btn btn-warning">Chi tiết</a></td>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <c:if test="${pageData.number > 0}">
                        <li class="page-item">
                            <a class="page-link" href="/sell/lich-su-thanh-toan?page=${pageData.number - 1}">Previous</a>
                        </li>
                    </c:if>
                    ...
                    <c:if test="${pageData.number +1 < pageData.getTotalPages()}">
                        <li class="page-item">
                            <a class="page-link" href="/sell/lich-su-thanh-toan?page=${pageData.number + 1}">Next</a>
                        </li>
                    </c:if>
