...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            <h2 style="text-align: center"> QUẢN LÝ HOÁ ĐƠN CHI TIẾT</h2>
...
<%--                    <th colspan="2" >Thao Tác</th>--%>
                ...
                <c:forEach items="${pageData.content}" var="st">
                    <tr>
                        ...
                        <td>${st.soLuong}</td>
                        <td>${st.donGia}</td>
                        <td><fmt:formatDate value="${st.thoiGian}" pattern="dd/MM/yyyy"/></td>
                        <td>${st.trangThai==1?"Đã thanh toán":""}
                        ${st.trangThai==0?"Chưa thanh toán":""}
                        ${st.trangThai==2?"Đã Huỷ":""}</td>

<%--                        <td><a href="/hoa-don-chi-tiet/edit/${st.ID}" class="btn btn-warning">Update</a></td>--%>
<%--                        <td><a href="/hoa-don-chi-tiet/delete/${st.ID}" return onclick="confirm('xác nhận') "--%>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <c:if test="${pageData.number > 0}">
                        <li class="page-item">
                            <a class="page-link" href="/hoa-don-chi-tiet/index?page=${pageData.number - 1}">Previous</a>
                        </li>
                    </c:if>
                    ...
                    <c:if test="${pageData.number +1 < pageData.getTotalPages()}">
                        <li class="page-item">
                            <a class="page-link" href="/hoa-don-chi-tiet/index?page=${pageData.number + 1}">Next</a>
                        </li>
                    </c:if>
