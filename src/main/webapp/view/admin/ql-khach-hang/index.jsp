        ...
        <div class="col py-3">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>${st.ten}</td>
                    <td>${st.SDT}</td>
                    <td>${st.trangThai==1?"Kích hoạt":"Không khích hoạt"}</td>
                    <td><a href="/khach-hang/edit/${st.ID}" class="btn btn-warning">Update</a></td>
                    <td><a href="/khach-hang/delete/${st.ID}" return onclick="confirm('xác nhận')"
