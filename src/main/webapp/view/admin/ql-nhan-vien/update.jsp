...
<body>
<%--<form method="post" action="/mau-sac/update/${MAUSAC.id}" >--%>
<div class="container" style="margin-top: 10px;">
    <div class="row"
         style="border: 1px darkgrey solid; border-radius: 10px; width: 50%; margin: 0 auto; padding: 20px;">
        <div class="col-sm-12">
            <h2 class="myclass" STYLE="text-align: center">CẬP NHẬT</h2>
            <sf:form method="post" action="/nhan-vien/update/${data.ID}" modelAttribute="data" >
                ...
                <div class="form-group">
                    ...
                    <sf:input class="form-control" type="text" name="tenDangNhap" path="tenDangNhap"/>
                    <sf:errors path="tenDangNhap" cssStyle="color: red"></sf:errors>
                </div>
                <div class="form-group">
                    <label>Mật khẩu</label>
                    <sf:input class="form-control" type="text" name="matKhau" path="matKhau"/>
                ...
                <button class="btn btn-success" type="submit" onclick="return confirm('Xác nhận ?')">Cập nhật</button>
                <a href="/nhan-vien/index" class="btn btn-primary ">Quay lại</a>
                </div>
