            ...
            <table class="table table-striped">
                ...
                <c:forEach items="${pageData.content}" var="st">
                    <tr>
                        ...
                        <td><a href="/nhan-vien/edit/${st.ID}" class="btn btn-warning">Update</a></td>
                        <td><a href="/nhan-vien/delete/${st.ID}" return onclick="confirm('xác nhận')"
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <c:if test="${pageData.number > 0}">
                        <li class="page-item">
                            <a class="page-link" href="/nhan-vien/index?page=${pageData.number - 1}">Previous</a>
                        </li>
                    </c:if>
                    ...
                    <c:if test="${pageData.number +1 < pageData.getTotalPages()}">
                        <li class="page-item">
                            <a class="page-link" href="/nhan-vien/index?page=${pageData.number + 1}">Next</a>
                        </li>
                    </c:if>
