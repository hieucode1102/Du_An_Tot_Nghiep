...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            <h2 style="text-align: center"> QUẢN LÝ SPCT</h2>
            ...
            <table class="table table-striped">
                ...
                <c:forEach items="${pageData.content}" var="st">
                    <tr>
                        ...
                        <td>${st.soLuong}</td>
                        <td>${st.donGia}</td>
                        <td><a href="/sp-chi-tiet/detail/${st.ID}" class="btn btn-info">Chi tiết</a></td>
                        <td><a href="/sp-chi-tiet/edit/${st.ID}" class="btn btn-warning">Cập nhật</a></td>
                        <td><a href="/sp-chi-tiet/delete/${st.ID}" return onclick="confirm('xác nhận') "
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <c:if test="${pageData.number > 0}">
                        <li class="page-item">
                            <a class="page-link" href="/sp-chi-tiet/index?page=${pageData.number - 1}">Previous</a>
                        </li>
                    </c:if>
                    ...
                    <c:if test="${pageData.number +1 < pageData.getTotalPages()}">
                        <li class="page-item">
                            <a class="page-link" href="/sp-chi-tiet/index?page=${pageData.number + 1}">Next</a>
                        </li>
                    </c:if>
