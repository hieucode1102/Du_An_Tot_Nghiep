            ...
            <table class="table table-striped">
                ...
                <c:forEach items="${pageData.content}" var="st">
                    <tr>
                        ...
                        <td><a href="/mau-sac/edit/${st.ID}" class="btn btn-warning">Chỉnh sửa</a></td>
                        <td>
                            <a href="/mau-sac/delete/${st.ID}" class="btn btn-danger"
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    ...
                    <c:if test="${pageData.number +1 < pageData.getTotalPages()}">
                        <li class="page-item">
                            <a class="page-link" href="/mau-sac/index?page=${pageData.number + 1}">Next</a>
                        </li>
                    </c:if>
